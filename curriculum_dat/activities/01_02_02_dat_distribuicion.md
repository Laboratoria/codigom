...
# 🔹Reto 1.2: Conociendo la distribución de los datos
...
Aprenderás a interpretar el concepto de distribución de los datos y a trabajar con histogramas.

## Descripción

Comprende la distribución de las variables "compras en línea" y "compras en tienda", construye un histograma y relaciona estos gráficos con la media y la mediana.

### Metas de Aprendizaje

- [x] Crear un histograma.
- [x] Interpretar correctamente los conceptos.

## Insumos para tu aprendizaje

- [Concepto histograma](https://docs.google.com/document/d/1-0USmtgZ1-mBw6G_E8OIoCkdvfjFDAeMJf28_gtNF9U/edit?usp=sharing).
- [Video como crear un histograma](https://www.youtube.com/watch?v=3fD_nqhQILA) 
